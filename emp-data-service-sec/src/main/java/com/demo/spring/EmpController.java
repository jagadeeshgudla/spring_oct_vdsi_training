...
public class EmpController {
	...
	@RequestMapping(path = "/emp/getEmp/{id}", method = RequestMethod.GET, produces = "application/json")
	...
	@RequestMapping(path = "/emp/getAllEmp", method = RequestMethod.GET, produces = "application/json")
	public List<Emp> getAllEmp() {
		List<Emp> empList = empRepo.findAll();
		return empList;
	}

	@RequestMapping(path = "/emp/save", method = RequestMethod.POST, produces = "text/plain", consumes = "application/json")
	...
	@RequestMapping(path = "/emp/update", method = RequestMethod.PUT, produces = "text/plain", consumes = "application/json")
